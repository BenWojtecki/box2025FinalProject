...
def find_pmaws(tsvfile, p, max_k):
    ...
    # 'active_candidates' stores words of length k that are NOT p-absent
        ...
        with Progress() as p:
            ...
            for word in next_candidates:
                for char in alphabet:
                    # We check canonical form here to limit the search space
...
def main():
    ...
    print(sum([len(a)for a in pmaws]))
